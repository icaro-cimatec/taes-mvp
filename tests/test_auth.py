...
def test_register_success(client, monkeypatch):
    ...
    response = client.post('/api/register', json={'name':'test', 'email': 'test@example.com', 'password': '123456'})
...
def test_login_success(client, monkeypatch):
    ...
    response = client.get('/api/login', json={'email': 'test@example.com', 'password': '123456'})
